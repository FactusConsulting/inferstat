...
public static class Render
{
    ...
    public static void Health(HealthResult r)
    {
        ...
        AnsiConsole.MarkupLine($"{status} [bold]{r.Endpoint}[/]  [grey]({r.ServerKind})[/]");
    ...
    public static void Models(ModelsResult r)
    {
        ...
        AnsiConsole.MarkupLine($"[bold]{r.Count}[/] model(s) on [cyan]{r.Endpoint}[/]");
    ...
    public static void Slots(SlotsResult r)
    {
        ...
        AnsiConsole.MarkupLine($"Slots on [cyan]{r.Endpoint}[/] — [yellow]{r.Busy}[/] busy, [green]{r.Idle}[/] idle (total {r.Total})");
        var t = new Table().Border(TableBorder.Rounded);
    ...
    public static void Metrics(MetricsResult r)
    {
        ...
        AnsiConsole.MarkupLine($"Metrics from [cyan]{r.Endpoint}[/] [grey]({r.ServerKind})[/]");
